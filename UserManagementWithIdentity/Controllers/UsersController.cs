...
namespace UserManagementWithIdentity.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(ProfileFormViewModel model)
        {
            ...
            var UserWithsameUserName = await _userManager.FindByEmailAsync(model.UserName);
            if (UserWithsameUserName != null && UserWithsameUserName.Id != model.Id)
            {
                ModelState.AddModelError("User name", "This Username is already Assiged To anther user");
                return View(model);
            }
